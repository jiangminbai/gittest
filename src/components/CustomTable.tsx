...
interface EnhancedTableProps {
  ...
  orderBy: string;
  rowCount: number;
  setColgroupVal?: React.Dispatch<React.SetStateAction<any[]>>
}

function EnhancedTableHead(props: EnhancedTableProps) {
  const { onSelectAllClick, order, orderBy, numSelected, rowCount, onRequestSort, setColgroupVal } =
    props;
